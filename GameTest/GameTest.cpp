...
void Init()
{
	...
	testSprite3 = App::CreateSprite(".\\TestData\\Test.bmp", 8, 4);
	testSprite3->SetPosition(600.0f, 600.0f);
	testSprite3->SetFrame(2);
	testSprite3->SetScale(2.0f);
	//------------------------------------------------------------------------
}
...
{	
	...
	// Example Text.
	//------------------------------------------------------------------------
	App::Print(100, 100, "I am smart and I believe in myself");
	App::Print(500, 500, "James Del Pilar");
}
//------------------------------------------------------------------------
